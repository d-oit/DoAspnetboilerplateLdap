...
namespace DoAspnetboilerplateLdap.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = DoAspnetboilerplateLdapConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(DoAspnetboilerplateLdapDbContext context)
        {
            _context = context;
        }
