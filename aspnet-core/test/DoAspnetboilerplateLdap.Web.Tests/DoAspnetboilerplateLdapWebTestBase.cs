...
{
    public abstract class DoAspnetboilerplateLdapWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DoAspnetboilerplateLdapWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DoAspnetboilerplateLdapWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DoAspnetboilerplateLdapDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DoAspnetboilerplateLdapDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DoAspnetboilerplateLdapDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DoAspnetboilerplateLdapDbContext, Task<T>> func)
        {
            T result;
